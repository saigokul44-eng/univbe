...
# Use /tmp directory on Vercel because of read-only serverless filesystem
DB_PATH = '/tmp/univibe.db' if os.environ.get('VERCEL') else 'univibe.db'
...
if __name__ == '__main__':
    ...
    print(f"Starting UniVibe on port {port}")
